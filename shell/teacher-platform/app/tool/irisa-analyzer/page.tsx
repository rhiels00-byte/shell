...
import InputForm, { type AnalyzeData } from '@/app/components-irisa/InputForm';
import ResultDisplay from '@/app/components-irisa/ResultDisplay';
import type { StudentAnalysisResult } from '@/app/types';
